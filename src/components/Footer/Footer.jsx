...
//               <button className="bg-[#E6E8E7] text-[#742092] rounded-full p-2 md:p-3 hover:bg-[#742092] hover:text-white transition duration-300 cursor-pointer flex items-center justify-center w-10 h-10 md:w-10 md:h-10 lg:w-12 lg:h-12">
//                 <FaFacebookF size={16} />
//               </button>
//               <button className="bg-[#E6E8E7] text-[#742092] rounded-full p-2 md:p-3 hover:bg-[#742092] hover:text-white transition duration-300 cursor-pointer flex items-center justify-center w-10 h-10 md:w-10 md:h-10 lg:w-12 lg:h-12">
//                 <FaXTwitter size={16} />
