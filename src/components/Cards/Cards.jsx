...
//       {/* Main Heading */}
//       <h2 className="text-2xl sm:text-3xl md:text-4xl text-[#742092] font-bold pt-6 pb-10 text-center max-w-3xl mx-auto leading-tight">
//         Follow Simple Steps To Buy Property
//       </h2>

//       {/* Cards Grid */}
//       <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 sm:gap-10 md:gap-12 mt-8">
//         {data.map((item) => (
//           <div
//             key={item.id}
//             data-aos="fade-up"
//             data-aos-delay={item.id * 100}
//             className={`relative bg-transparent sm:bg-gray-100 rounded-lg sm:rounded-xl pt-20 pb-8 px-3 sm:px-4 text-center group hover:shadow-lg transition w-full mx-auto
//               ${item.id % 2 === 1 ? "translate-y-0" : "sm:translate-y-3 md:translate-y-6 lg:translate-y-12"}
//             `}
//           >
//             {/* Image Container */}
...
export default function Cards() {
  ...
  return (
    <div className="w-full bg-white px-4 sm:px-7 md:px-12 lg:px-16 py-10 sm:py-12 md:py-16">
      ...
      {/* Main Heading */}
      <h2 className="text-2xl sm:text-3xl md:text-4xl lg:mb-20 text-[#742092] font-bold pt-6 pb-10 text-center max-w-3xl mx-auto leading-tight">
        Follow Simple Steps To Buy Property
      </h2>

      {/* Cards Grid */}
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-10 md:gap-10 lg:gap-12 mt-8">
        {data.map((item) => (
          <div
            key={item.id}
            data-aos="fade-up"
            data-aos-delay={item.id * 100}
            className={`relative bg-transparent rounded-lg sm:rounded-xl pt-20 pb-8 px-3 sm:px-4 text-center group hover:shadow-lg transition w-full mx-auto
              ${
                item.id % 2 === 1
